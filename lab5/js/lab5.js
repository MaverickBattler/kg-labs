function main() {
    ...
    function drawScene(
        ...
        webglUtils.setUniforms(programInfo, {
			...
			u_world: m4.scale(m4.translation(0, 3, 2), 1, 1, 1), // (x, y, z) - координаты, далее три числа размеры
		});
        ...
        webglUtils.setUniforms(programInfo, {
			...
			u_color: [0, 0, 1, 1],
			u_texture: checkerboardTexture,
			u_world: m4.scale(m4.translation(0, 1, 2), 1, 1, 1),// (x, y, z) - координаты, далее три числа размеры
		});
        ...
        webglUtils.setUniforms(programInfo, {
            ...
            u_color: [0, 0, 1, 1],
            u_texture: checkerboardTexture,
            u_world: m4.scale(m4.translation(1.5, 1, -1), 1.5, 3, 1.5),// (x, y, z) - координаты, далее три числа размеры
        });
        // calls gl.drawArrays or gl.drawElements
        ...
        webglUtils.setUniforms(programInfo, {
            ...
            u_color: [0, 0, 1, 1],
            u_texture: checkerboardTexture,
            u_world: m4.scale(m4.translation(2.5, 1, 2), 1, 2.5, 1),// (x, y, z) - координаты, далее три числа размеры
        });
        // calls gl.drawArrays or gl.drawElements
        ...
        webglUtils.setUniforms(programInfo, {
            ...
            u_color: [0, 0, 1, 1],
            u_texture: checkerboardTexture,
            u_world: m4.scale(m4.translation(-3, 1, 2), 1, 2, 1),// (x, y, z) - координаты, далее три числа размеры
        });
        // calls gl.drawArrays or gl.drawElements
